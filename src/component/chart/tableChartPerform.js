                ...
                <Table.Body>
                    {
                        list.map((index) => (
                            <Table.Row key={index}>
                                ...
                                <Table.Cell> <Progress value={index.value_added} total={2000} color='violet' size='small' label={index.value_added}/> </Table.Cell>
                                <Table.Cell> <Progress  value={index.perform_radtio} total={100} color='violet' size='small' label={index.perform_radtio + '%'}/> </Table.Cell>
                                <Table.Cell><Progress  value={index.waste} total={100} color='violet' size='small' label={index.waste + '%'}/> </Table.Cell>
                            </Table.Row>
                        ))
                    }
                </Table.Body>
