...
const Step1 = ({data, onPrevious, onNext, setShow, step, allData, onChanges, timeline, projectId}) => {
    ...
    return (
        <div>
            ...
            <div className={classes.div}>
                <CCardBody>
                    <CCardText style={{ lineHeight: 2, marginLeft: 30, fontSize: 18, fontFamily: 'Prompt' }}> 1. คุณภาพ : ผลงาน หรืองานที่ทำ มีความละเอียด ถูกต้องครบถ้วน ได้ตามมาตรฐาน ไม่มีการแก้ไขหรือปรับปรุง </CCardText>
                    ...
                    { step >= 0 & step < 7 ? (
                        ...
                        <Button onClick={() => onClickConfirm(array)}  className={classes.button}>
                            ถัดไป
                        </Button>
                        </>
                        ) : (
