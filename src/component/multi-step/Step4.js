...
const Step4 = ({data, onPrevious, onNext, setShow, step, allData, onChanges, timeline, projectId}) => {
    ...
    return (
        <div>
            ...
            <div className={classes.div}>
                <CCardBody>
                    <CCardText style={{ lineHeight: 2, marginLeft: 30, fontSize: 18, fontFamily: 'Prompt' }}>4. ความน่าเชื่อถือ : ไว้ใจได้ มีความซื่อสัตย์ ไม่ต้องคอยตรวจเช็ค ตรวจสอบ หรือติดตามควบคุม </CCardText>
