...
const ResultEigth= ({data}) => {
    ...
    $(function () {
        ...
        $("#pivotTable8").html(arrayToHTMLTableH(output)).css({"background-color": "#F5F5F5"},{ 'font-family':'sans-serif'});
    });
        ...
        <>
        {
                datas.length !== 0 ? (
                  ...
                  <CCardText style={{ lineHeight: 2, fontSize: 18, fontFamily: 'Prompt', textAlign: 'left', marginBottom: '20px' }}>
                    8. ความปลอดภัย : คำนึงถึงความปลอดภัยอย่างเคร่งครัดต่อตนเอง และผู้อื่น
                  </CCardText> 
