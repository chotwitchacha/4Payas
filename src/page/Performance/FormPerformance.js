...
const FormPerformance = ({show, setShow, employeeId, project, timeLine, employeeName}) => {
    ...
    const changeValueRatio = (event, value) => {
        setPersent(value);
    };

    const onChangeRadio = (e) => {
        setRadio(e.target.value);
        console.log('หน่วย', e.target.value);
    };

    const onChangeWaste = (event, value) => {
        setWaste(value);
    };
